...
public class Cores {
	...
	/*
	 * Criamos a constante TEXT_RESET, do tipo final, 
	 * que armazena o código ANSI responsável por resetar as cores do texto e do fundo de tela. 
	 * O nome está em letras maiúsculas por se tratar de uma constante, 
	 * ou seja, um valor fixo que não pode ser alterado.
	 */
	...
	/* 
	 * Definimos as constantes que representam as 8 cores básicas para o texto, 
	 * utilizando seus respectivos códigos ANSI. 
	 * Todas as variáveis são final e estão em letras maiúsculas,
	 * seguindo a convenção de nomenclatura para constantes.
	 */
	...
	/*
	 * Criamos constantes que representam as 8 cores básicas 
	 * com a propriedade negrito (bold) aplicada ao texto. 
	 * Cada constante armazena o código ANSI correspondente, 
	 * e segue o mesmo padrão de nomenclatura e imutabilidade.
	 */
	...
	/* 
	 * Definimos as constantes com as 8 cores básicas com a propriedade 
	 * sublinhado (underline) habilitada para o texto, 
	 * utilizando os códigos ANSI apropriados.
	 */
	...
	/*
	 * Criamos constantes com as 8 cores básicas com efeito brilho (bright), 
	 * que resultam em cores mais claras no texto. 
	 * Todas seguem a mesma estrutura de definição e padronização.
	 */
	...
	/* 
	 * Definimos as constantes com as 8 cores básicas com brilho e negrito combinados, 
	 * proporcionando maior destaque ao texto. São todas constantes do tipo final, 
	 * com seus respectivos códigos ANSI.
	 */
	...
	/*
	 * Declaramos as constantes com as 8 cores básicas aplicáveis ao fundo da tela (background),
	 * utilizando os códigos ANSI equivalentes.
	 */
	...
	/*
	 * Criamos as constantes com as 8 cores básicas em modo brilho (bright) 
	 * para o fundo da tela (background), também definidas com os respectivos códigos ANSI.
	 */
